...
def main(dpath, spath_root, mpath, gt_name, test_flag, case):
    ...
    CG_maxiter = 5 #limit CG_iter to 3 iters for fully-sampled data to prevent artifacts
    ...
    rmse_tol = 3.0 #heuristics, found that this corresponds to acceptable correction for R = 2
...
if __name__ == "__main__":
    mpath = r'/home/nghiemb/PyMoCo/data/cc/test/PE1_AP/Complex/R2/Paradigm_2D'
    cases = [1,4,5,6,7]
