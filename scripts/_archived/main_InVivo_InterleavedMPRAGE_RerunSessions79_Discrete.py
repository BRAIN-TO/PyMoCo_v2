...
def main(sub, dpath, spath_root, mpath, gt_name, flag, cerebrum_slice):
    ...
    if JE_flag and cnn_flag: #UNet + JE
        ...
        spath = spath_root + r'/wo_cnn_CorrectMask_MaxIter750'
        max_loops = 250 #ie. additional 500 iterations, picking from previous run
    ...
    spath_temp = spath_root + r'/wo_cnn_CorrectMask_MaxIter500' #path for initial run
...
if __name__ == "__main__":
    ...
    #
    run_only = [6,8] #rerun only test cases 7, 9
