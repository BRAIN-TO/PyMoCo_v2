...
#-------------------------------------------------------------------------------
def main(sub, dpath, spath, mpath, gt_name, flag, cerebrum_slice):
    #---------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    spath_sub1 = dpath_sub1 + r'/w_cnn_combo_PE1_AP'
    ...
    spath_sub2 = dpath_sub2 + r'/w_cnn_combo_PE1_AP_CorrectMask'
    ...
    spath_sub3 = dpath_sub3 + r'/w_cnn_combo_PE1_AP_CorrectMask_Rerun-06-19-2024'
    ...
    spath_sub4 = dpath_sub4 + r'/w_cnn_combo_PE1_AP_CorrectMask_Rerun-06-19-2024'
    ...
    spath_sub5 = dpath_sub5 + r'/w_cnn_combo_PE1_AP_CorrectMask_Rerun-06-19-2024'
    ...
    spath_sub6 = dpath_sub6 + r'/w_cnn_combo_PE1_AP_CorrectMask_Rerun-06-19-2024'
    ...
    spath_sub7 = dpath_sub7 + r'/w_cnn_combo_PE1_AP_CorrectMask_Rerun-06-24-2024'
    ...
    spath_sub8 = dpath_sub8 + r'/w_cnn_combo_PE1_AP_CorrectMask_250Iters'
    ...
    spath_sub9 = dpath_sub9 + r'/w_cnn_combo_PE1_AP_CorrectMask_250Iters'
    ...
    spath_sub10 = dpath_sub10 + r'/w_cnn_combo_PE1_AP_CorrectMask_250Iters'
    ...
    for sub in subset:
        ...
        mpath, dpath, gt_name, cerebrum_slice, spath = paths
        flags = [[1,1]] #Running UNet+JE
        for flag in flags:
            DC_vals = main(sub, dpath, spath, mpath, gt_name, flag, cerebrum_slice)
