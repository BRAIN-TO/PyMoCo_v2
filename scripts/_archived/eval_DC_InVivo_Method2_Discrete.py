...
def main(sub, dpath, spath, mpath, gt_name, flag, cerebrum_slice):
    ...
    #
    DC_vals = []
    # DC_norm = rec.eval_TotalDC(Mtraj_init, fixed_vars, JE_params)
...
if __name__ == "__main__":
    ...
    spath_sub1 = dpath_sub1 + r'/wo_cnn'
    ...
    spath_sub2 = dpath_sub2 + r'/wo_cnn_CorrectMask'
    ...
    spath_sub3 = dpath_sub3 + r'/wo_cnn_CorrectMask'
    ...
    spath_sub4 = dpath_sub4 + r'/wo_cnn_CorrectMask_Rerun-06-19-2024'
    ...
    spath_sub5 = dpath_sub5 + r'/wo_cnn_CorrectMask'
    ...
    spath_sub6 = dpath_sub6 + r'/wo_cnn_CorrectMask'
    ...
    spath_sub7 = dpath_sub7 + r'/wo_cnn_CorrectMask_MaxIter750/'
    ...
    spath_sub8 = dpath_sub8 + r'/wo_cnn_CorrectMask_MaxIter500'
    ...
    spath_sub9 = dpath_sub9 + r'/wo_cnn_CorrectMask_MaxIter750'
    ...
    spath_sub10 = dpath_sub10 + r'/wo_cnn_CorrectMask'
