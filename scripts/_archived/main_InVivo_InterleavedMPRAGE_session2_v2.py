...
def main(dpath, spath_root, mpath, gt_name):
    ...
    # U = eop._U_Array2List(U, s_corrupted.shape[1:])
    #---------------------------------------
    # #**TESTING SAMPLING PATTERN WITH LOWER RES THAN NOMINAL
    # upscale = 2
    # U = eop._U_combine(U, upscale)
    #---------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    test_case = 'scan7-mild-16shots'
    gt_name = 'scan6-reference-16shots'
    # test_case = 'scan9-severe-16shots'
    # gt_name = 'scan8-reference-16shots'
