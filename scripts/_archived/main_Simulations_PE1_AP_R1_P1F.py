...
def main(dpath, spath_root, mpath, gt_name, test_flag, case):
    ...
    if JE_flag and cnn_flag: #UNet + JE
        spath = spath_root + r'/w_cnn_ReIm_3000Iters_July-10-2024'
        max_loops = 1500
        spath_temp = spath_root + r'/w_cnn_ReIm_1500Iters_July-10-2024'
    elif JE_flag and not cnn_flag: #only JE
        spath = spath_root + r'/wo_cnn_500Iters_July-10-2024'
        max_loops = 136
        spath_temp = spath_root + r'/wo_cnn_750Iters_July-10-2024'
    elif not JE_flag and cnn_flag: #only UNet
        spath = spath_root + r'/w_only_cnn_magnitude_central_July-10-2024'
        max_loops = 1
    ...
    DC_store = list(np.load(spath_temp + r'/DC_store.npy'))
    try:
