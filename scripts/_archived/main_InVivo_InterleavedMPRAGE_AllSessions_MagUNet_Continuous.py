...
#-------------------------------------------------------------------------------
def main(sub, dpath, spath_root, mpath, gt_name, flag):
    #---------------------------------------------------------------------------
    ...
    m_corrupted = m_init
    ############################################################################
    ########    USING M_CORRUPTED FOR RESCALING, WHICH IS FINE FOR UNET SINCE JUST NEED MAXVAL ~ 1    ############################################################################
    # subset = [1,2,3,4]
    # if sub in subset:
    ...
    if JE_flag and cnn_flag: #UNet + JE
        spath = spath_root + r'/w_cnn_combo_PE1_AP_CorrectMask_ALT'
        max_loops = 250
...
if __name__ == "__main__":
    ...
    paths_sub1 = [mpath_sub1, dpath_sub1, gt_name_sub1]
    #
    ...
    gt_name_sub2 = 'scan2-InstructedMotion-16shots'
    paths_sub2 = [mpath_sub2, dpath_sub2, gt_name_sub2]
    #
    mpath_sub3 = r'/home/nghiemb/Data/TWH/MPRAGE_PE1Reordered/Scan20230831/Sub2'
    dpath_sub3 = mpath_sub3 + r'/scan4-FreeMotion-16shots'
    gt_name_sub3 = 'scan3-Reference-16shots'
    paths_sub3 = [mpath_sub3, dpath_sub3, gt_name_sub3]
    #
    mpath_sub4 = r'/home/nghiemb/Data/TWH/MPRAGE_PE1Reordered/Scan20230925/Sub1'
    dpath_sub4 = mpath_sub4 + r'/scan4-FreeMotion-16shots'
    gt_name_sub4 = 'scan4-FreeMotion-16shots'
    paths_sub4 = [mpath_sub4, dpath_sub4, gt_name_sub4]
    #
    ...
    paths_sub5 = [mpath_sub5, dpath_sub5, gt_name_sub5]
    #
    ...
    # paths_sub6 = [mpath_sub6, dpath_sub6, gt_name_sub6]
    # #
    ...
    paths_sub7 = [mpath_sub7, dpath_sub7, gt_name_sub7]
    #
    ...
    paths_sub8 = [mpath_sub8, dpath_sub8, gt_name_sub8]
    #
    ...
    paths_sub9 = [mpath_sub9, dpath_sub9, gt_name_sub9]
    #
    ...
    paths_sub10 = [mpath_sub10, dpath_sub10, gt_name_sub10]
    #
    ...
    for i, paths in enumerate(paths_list):
        ...
        mpath, dpath, gt_name = paths
        spath_root = dpath        
        flags = [[1,0]] #Running only the UNet
        for flag in flags:
            spath, m_corrupted, m_final, m_loss_store, Mtraj_store = main(sub, dpath, spath_root, mpath, gt_name, flag)
            xp.save(spath + r"/m_corrupted.npy", m_corrupted)
