...
def main(dpath, spath_root, mpath, gt_name, test_flag):
    ...
    # C = xp.pad(C, ((0,0), (5,5), (0,0), (0,0)))
    # xp.save(dpath + r'/sens.npy', C)
    ...
    # U_array = np.load(dpath + r'/U.npy', allow_pickle=1)
...
if __name__ == "__main__":
    mpath = r'/home/nghiemb/PyMoCo/data/cc/test/PE1_AP/Complex/R1/Paradigm_1'
    # cases = [1,4,5,6,7]
    cases = [4,5,6,7]
