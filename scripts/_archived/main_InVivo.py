...
def mem_profile():
    ...
    print("GPU Memory : ({:.2f}% free): {}(total), {} (free), {} (used)".format(100*info.free/info.total, info.total, info.free, info.used))
    nvidia_smi.nvmlShutdown()

def complex32(a):
    #Return Real and Imaginary parts of complex input
    #as a list of half-precision floats
    a_re16 = xp.real(a).astype(xp.float16)
    a_im16 = xp.imag(a).astype(xp.float16)
    return xp.array([a_re16, a_im16], dtype = xp.float16)
...
dpath = r'/home/nghiemb/PyMoCo/data/cc/test/severe/Test1'
spath_root = r'/home/nghiemb/PyMoCo/data/cc/test/combo/severe_cases/Test1'
...
#-------------------------
#In-Vivo dataset
mpath = r'/home/nghiemb/Data/TWH/MPRAGE_ReferencePoses/InVivo/sub-01/dat/corrupted'
i = 2
print('Processing Test Case {}'.format(i))
dpath = os.path.join(mpath, 'Test{}'.format(i))
spath_root = dpath
