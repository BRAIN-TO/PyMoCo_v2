...
def main(sub, dpath, spath_root, mpath, gt_name, flag, cerebrum_slice):
    ...
    if JE_flag and cnn_flag: #UNet + JE
        ...
        spath = spath_root + r'/wo_cnn_CorrectMask_Rerun-06-19-2024'
        max_loops = 550 #ie. additional 250 iterations, picking from previous run
    ...
    spath_temp = spath_root + r'/wo_cnn_CorrectMask_Rerun-06-19-2024' #path for initial run
...
if __name__ == "__main__":
    ...
    #
    # run_only = [3,6,8] #UPDATE May 27 - I forgot to rerun Sub 8
    run_only = [3] #rerun only test cases 4
    max_iters = [800]
    count = 0
