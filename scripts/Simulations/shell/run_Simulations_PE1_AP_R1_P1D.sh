...
export SUBMIT_DIR=/home/nghiemb/PyMoCo
export OUT_DIR=${SUBMIT_DIR}/data/cc/test/PE1_AP/Complex/R1/Paradigm_1D

python ${SUBMIT_DIR}/main_Simulations_PE1_AP_R1_P1D.py > ${OUT_DIR}/log_P1D_2025-04-14.txt & disown
